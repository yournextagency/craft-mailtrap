...
> and Composer 2.10 refuses to install such a package by default. That blocks **creating a new
> Craft 4 project**, before this plugin is involved at all. Adding the plugin to an existing
> Craft 4 site is unaffected: Composer keeps the version already in `composer.lock` and only
> prints a warning. This is a constraint in Craft itself, not in this plugin.
